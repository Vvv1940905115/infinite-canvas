...
export default {
  ...
  theme: {
  	...
  	extend: {
      /* __DS_BURN_START__ */
      fontFamily: { sans: ["\"Rubik\", \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", \"Noto Sans SC\", -apple-system, system-ui, \"Segoe UI\", Helvetica, Arial, sans-serif"], display: ["\"Dammit Sans\", \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", \"Noto Sans SC\", \"Rubik\", -apple-system, system-ui, \"Segoe UI\", Helvetica, Arial, sans-serif"], mono: ["Monaco, \"PingFang SC\", \"Hiragino Sans GB\", \"Microsoft YaHei\", \"Noto Sans SC\", Menlo, \"Ubuntu Mono\", ui-monospace, monospace"] },
